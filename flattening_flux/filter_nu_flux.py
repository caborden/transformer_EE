...
def load_inverse_xsec_data(directory):
    ...
    """
    file_map = {
        "NuMu": "numu_AR23_0p1-10GeV_inverse_xsec_as_flux.data",
        "NuMubar": "numubar_AR23_0p1-10GeV_inverse_xsec_as_flux.data",
        "NuE": "nue_AR23_0p1-10GeV_inverse_xsec_as_flux.data",
        "NuEbar": "nuebar_AR23_0p1-10GeV_inverse_xsec_as_flux.data",
        "NuTau": "nutau_AR23_0p1-10GeV_inverse_xsec_as_flux.data",
        "NuTaubar": "nutaubar_AR23_0p1-10GeV_inverse_xsec_as_flux.data",
    }
...
def process_flux_file(input_file, output_file, energy_threshold=10.0, data_dir="."):
    """
...
if __name__ == "__main__":
    ...
    output_filename = "filtered-hms-ally-20-12-solmax_3FlavOsc.d"  # Output file
